    ...
    >
      <div className="max-w-xl mx-auto">
        ...
        >
          ...
          <span style={{ display: "block", marginTop: "1.25rem", textDecoration: "underline" }}>Preinscripciones</span>
          <span style={{ display: "block", textDecoration: "underline" }}>hasta el 15 de agosto.</span>
        </h2>
        <p
